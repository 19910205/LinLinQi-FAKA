...
// Browser wallet extensions can reject an injected Tron provider on pages that
// do not have a wallet. Keep that third-party rejection from masking app
// errors; the extension still logs its own diagnostic in its isolated script.
